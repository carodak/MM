...
if not os.path.exists(dir+"base_planar_k5k33"):
    ...
    os.makedirs(dir+"base_planar_k5k33/learning-planar-minor_18_[0,1]_1000")

if not os.path.exists(dir+"base_planar_k5"):
    os.makedirs(dir+"base_planar_k5")
    os.makedirs(dir+"base_planar_k5/learning-planar-minor_18_[0,1]_1000")

if not os.path.exists(dir+"base_planar_k5k33"):
    os.makedirs(dir+"base_planar_k33")
    os.makedirs(dir+"base_planar_k33/learning-planar-minor_18_[0,1]_1000")
...
mmu.store_base(lb, dir+"base_planar_k33/learning-planar-minor_18_[0,1]_1000")
mmu.store_base(lb2, dir+"base_planar_k5/learning-planar-minor_18_[0,1]_1000")
mmu.store_base(lb3, dir+"base_planar_k5k33/learning-planar-minor_18_[0,1]_1000")
