...
base_path = parent_parent_path+'/Outputs/Bases/JSON/tree_base_test_18_20_1/learning-base-rdm_18_[0, 1]_20'
...
print("learning base simple classification: ",learning_base)
